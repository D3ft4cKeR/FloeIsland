// Shared constants for FloeDock.
// Keep this file free of gi:// / resource:// imports so it can be
// syntax-checked and unit-tested with plain node/gjs.

export const UUID = 'floedock@floedock.github.io';
export const SETTINGS_SCHEMA = 'org.gnome.shell.extensions.floedock';
export const ROLE = 'floedock';
...
// --- geometry -------------------------------------------------------------
export const TOOL_PITCH = 26;           // pitch (px) between hover-toolbar buttons
export const TOOL_DIAMETER = 22;        // toolbar button diameter
export const TOOLBAR_PADDING = 6;       // toolbar side padding
export const TOOLBAR_HEIGHT = 30;       // toolbar height (compact, fits the panel)
export const PANEL_HEIGHT = 420;        // full panel height
...
export const NOTIF_HEIGHT = 72;         // notification state height
