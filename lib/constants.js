...
// --- geometry -------------------------------------------------------------
export const TOOL_PITCH = 40;           // pitch (px) between hover-toolbar buttons
export const TOOL_DIAMETER = 28;        // toolbar button diameter
export const TOOLBAR_PADDING = 10;      // toolbar side padding
export const TOOLBAR_HEIGHT = 38;       // toolbar height (compact, fits the panel)
