...
// --- geometry -------------------------------------------------------------
export const TOOL_PITCH = 48;           // pitch (px) between hover-toolbar buttons
export const TOOL_DIAMETER = 32;        // toolbar button diameter
export const TOOLBAR_PADDING = 12;      // toolbar side padding
