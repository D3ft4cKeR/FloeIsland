...
export function createFullPanel(dock, ext) {
    ...
    // 面板玻璃样式（深色玻璃，圆角/主题色来自设置）
    const applyPanelStyle = () => {
        root.set_style(`
            background-gradient-direction: vertical;
            background-gradient-start: rgba(24,30,42,${theme.topAlpha});
            background-gradient-end: rgba(7,10,16,${theme.baseAlpha});
    ...
    // GNOME 50 St.Entry 文字色有时不随 CSS：显式设为白色，避免黑底黑字
    searchEntry.clutter_text.color = Clutter.color_new(255, 255, 255, 255);
