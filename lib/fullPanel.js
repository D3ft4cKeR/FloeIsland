...
export function createFullPanel(dock, ext) {
    ...
    // 直接 add_child 到 ScrollView（GNOME 50 内部管理 viewport，滚动才正常）
    resultsScroll.add_child(resultsList);
    ...
    addModule('倒计时', 'alarm-symbolic', createTimerModule);
    addModule('秒表', 'chronometer-symbolic', createStopwatchModule);
