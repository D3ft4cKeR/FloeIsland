...
export function createWeatherModule({dock, ext}) {
    ...
    const root = new St.BoxLayout({
        style_class: 'floedock-module', x_expand: true, y_expand: true,
        clip_to_allocation: true, style: 'spacing: 10px;',
    });
    ...
    const content = new St.BoxLayout({x_expand: true, style: 'spacing: 10px;'});
    content.hide();
    ...
    function makeD(p, l) {
        const r = new St.BoxLayout({style: 'spacing: 6px;'});
